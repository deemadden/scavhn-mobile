  ...
  function(App, BaseView, template, Debug)
  {
    return BaseView.extend({
      ...
      events: {
        ...
        'click .scav-item-camera-native-cta a' : 'takePictureClick',
      ...
      {
        Debug.log('ScavItemsNativeView -> activate()', viewData);
      ...
      takePictureClick: function(e)
      {
        e.preventDefault();

        App.getInstance().getDep('viewmodels/AppViewModel').showLoadIndicator();

        if($('div.scav-item-camera-native-cta').hasClass('retake-picture-native'))
          this.restoreOperatorIconAndResultMessage();

        var data = { selectedScavItemId: this.selectedScavItemId };
        this.trigger('native-verify-found-scav-item:click', data);
      },

      updateCameraViewWithResult: function (data, base64scavItemFoundImage)
      {
        Debug.log('ScavItemsNativeView > updateCameraViewWithResult', base64scavItemFoundImage);

        var view = this;
        this.displayResultView(view, base64scavItemFoundImage);
      ...
      showCameraViewSuccess: function(data)
      {
        ...
        $operatorIcon.transition({ scale: 0 })
                     ...
                     .transition({ scale: 1.0 }, 200, 'snap', function() {
                        ...
                        $('div.scav-item-camera-native-cta.new-picture-native').fadeOut();
      ...
      {
        Debug.log('ScavItemsNativeView > showCameraViewNotFound');
        ...
        if(!$('div.scav-item-camera-native-cta').hasClass('retake-picture-native'))
        {
          ...
          $operatorIcon.transition({ scale: 0 })
                       ...
                       .transition({ scale: 1.0 }, 200, 'snap', function() {
                         ...
                         $('div.scav-item-camera-native-cta').fadeOut(function() {
                           $(this).removeClass('new-picture-native').addClass('retake-picture-native');
                           $(this).fadeIn();
                         });
      ...
      displayResultView: function (view, base64scavItemFoundImage)
      {
        ...
        $('.scav-camera-initial-view').fadeOut('fast', function () {
          ...
          $scavItemFoundImageElement.attr('src', "data:image/jpeg;base64," + base64scavItemFoundImage);
      ...
      {
        var $scavCameraCta = $('.scav-item-camera-native-cta');
        if ($scavCameraCta.hasClass('retake-picture-native')) {
          $scavCameraCta.removeClass('retake-picture-native')
            .addClass('new-picture-native');
        }
